...
export default function SurahDetail() {
  ...
  const { surah, translation, loading } = useSurahDetail(number);
  ...
  const fontSizeClasses = {
    sm: { arabic: 'text-xl', english: 'text-sm' },
    md: { arabic: 'text-2xl', english: 'text-base' },
    lg: { arabic: 'text-3xl', english: 'text-lg' },
  };
      ...
      <div className="min-h-screen bg-background dark">
        ...
        <main className="py-8 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/read">
              <Button>Go back to Surah list</Button>
            </Link>
          </div>
        </main>
        <Footer />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-accent/5 rounded-2xl p-8 mb-8 text-center border border-primary/20">
            <div className="flex items-center justify-center gap-2 mb-2">
              <span className="w-8 h-8 bg-primary/20 rounded-lg flex items-center justify-center text-sm font-semibold text-primary">
                {surah.number}
              </span>
              <span className={cn(
          ...
          {number !== 1 && number !== 9 && (
            <div className="text-center py-8 mb-8 border-b border-border">
              <p className="font-arabic text-3xl text-foreground">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    currentAyah === ayah.numberInSurah && 'border-primary/50 bg-primary/5'
                  )}
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-1">
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => handleBookmark(ayah.numberInSurah, translationAyah?.text || '')}
                  ...
                  <p
                    className={cn(
                      'font-arabic text-foreground text-right leading-loose mb-4',
                      fontSizeClasses[fontSize].arabic
                    )}
                    dir="rtl"
                  >
                    {ayah.text}
                  ...
                  {translationAyah && (
                    <p className={cn('text-muted-foreground leading-relaxed', fontSizeClasses[fontSize].english)}>
